                    ...
                    <>
                      <tr>
                        ...
                        <td>
                          ...
                          <button onClick={() => cancelUser(user)}>
                            Cancel
                          </button>
                        </td>
                      </tr>
              ...
              >
                {[
                  ...
                  return (
                    <option
                      value={role}
                      selected={role === (userToModify ? userToModify.clinicUser.userType: "MEDICAL_REGISTRAR")}
                    >
                      {role}
                    </option>
                  );
...
function modifyUser(
  ...
  if (user) {
    if (window.confirm(`Are you sure you want to modify values of user: ${user.firstName} ${user.lastName}`)) {
      //modify user
      setUser(undefined);
      setRefresh(!refresh)
    }
